...
class Request {
    ...
    public function init($options = array()) {
        ...
        $filename = CONFIG_PATH . 'routes.php';
...
//        }
    ...
    public function getControllerPath() {
        return 'app/modules/' . $this->module . '/controllers/' . $this->controllerClassName . '.class.php';
    }
    ...
    public function getViewPath() {
        return 'app/modules/' . $this->module . '/views/' . $this->controller . '/' . $this->action . '.html';
    }
